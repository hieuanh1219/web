...
//     // ưu tiên cùng type, nếu thiếu thì fallback theo giá ±25%
...
//               {rental.rentalPeriod && <Badge>⏱ {rental.rentalPeriod}</Badge>}
...
//               />
//               <InfoCard icon="🚿" label="Phòng tắm" value={rental.bathrooms} />
//               <InfoCard icon="🏷" label="Loại hình" value={rental.type || "—"} />
//             </div>

//             {/* CTA */}
//             <div className="mt-6 ">
//               {/* <button className="rounded-2xl bg-blue-600 px-5 py-3 font-semibold text-white shadow-sm transition hover:bg-blue-700"> */}
//                 <button className="w-full  rounded-2x1 bg-blue-600 px-5 py-3 font-semibold text-white shadow-sm transition hover:bg-blue-700">
//                 Liên hệ tư vấn
//               </button>
